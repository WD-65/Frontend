const slicedArray1 = products.slice(1, 4); // From index 1 to 3
...
// ⭐ Challenge:
/*
  Imagine you have a list of products and you want to show 3 items per page.
